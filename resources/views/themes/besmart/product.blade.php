        ...
        <div class="col-md-4">
            <div class="left-product-info">
                ...
                <div style="margin-top: 20px;">
                    <a href="https://api.whatsapp.com/send?phone=77777941654&text=Здравствуйте!%20Я%20хотел%20бы%20узнать%20по%20подробнее%20о товаре%20!.%20Спасибо!%20Артикуль товара:%20{{ $product->id }}%20Товар%20по%20этому%20адресу:%20{{ $product->url() }}">
